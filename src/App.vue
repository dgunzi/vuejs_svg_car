...
export default {
  data () {
    return {
      carHref: require('../static/car.svg') + '#Capa_1',
      width: 50,
      height: 50,
      x: 100,
      y: 100,
  ...
  created () {
    ...
    window.addEventListener('keydown', e => {
      ...
      if (e.keyCode === 37) this.start(-1, 'turn')
      else if (e.keyCode === 39) this.start(1, 'turn')
      else if (e.keyCode === 38) this.start(1, 'move')
      else if (e.keyCode === 40) this.start(-1, 'move')
    })
  ...
  methods: {
    ...
    render () {
      ...
      if (this.turn.speed) {
        ...
        let relSpeed = this.move.speed + 0.3
